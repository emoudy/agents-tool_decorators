...
from src.framework import Action, ActionRegistry, Agent, Environment, Memory
...
class TestActionRegistry(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_action = Action(name="test_action", function=dummy_function, description="Test action", parameters={})
...
class TestMemory(unittest.TestCase):
    ...
    def test_get_memories(self):
        ...
        items = [{"type": "user", "content": "Hello"}, {"type": "assistant", "content": "Hi there"}]
        for item in items:
    ...
    def test_get_memories_with_limit(self):
        ...
        items = [{"type": "user", "content": "1"}, {"type": "user", "content": "2"}, {"type": "user", "content": "3"}]
        for item in items:
            self.memory.add_memory(item)
...
class TestEnvironment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_action = Action(name="test_action", function=test_function, description="Test action", parameters={})
